...
export const initialCategories: Category[] = [
  { id: 'development', name: 'Development', iconName: 'Code2', skillsCount: 4, description: 'Code execution, databases, git integrations, sandboxes, and APIs' },
  { id: 'writing', name: 'Writing', iconName: 'PenTool', skillsCount: 1, description: 'Content writing, editing, formatting, and translation tools' },
  { id: 'research', name: 'Research', iconName: 'BookOpen', skillsCount: 2, description: 'Search engines, data scraping, wikipedia, and scholarly search' },
  { id: 'marketing', name: 'Marketing', iconName: 'Megaphone', skillsCount: 1, description: 'SEO optimization, copy writing, and social media posting content solvers' },
  { id: 'design', name: 'Design', iconName: 'Palette', skillsCount: 1, description: 'Figma automation, SVG generator, and style system interfaces' },
  { id: 'productivity', name: 'Productivity', iconName: 'Clock', skillsCount: 2, description: 'Note-taking, scheduling, task managers, and notifications' },
  { id: 'automation', name: 'Automation', iconName: 'Cpu', skillsCount: 3, description: 'Browser scripting, server controls, and background cron scripts' },
  { id: 'education', name: 'Education', iconName: 'GraduationCap', skillsCount: 1, description: 'Tutorial generators, memory cards, and language tutors' },
  { id: 'business', name: 'Business', iconName: 'Briefcase', skillsCount: 2, description: 'Financial reports, spreadsheet integrations, and CRM syncs' },
  { id: 'agents', name: 'Agents', iconName: 'Bot', skillsCount: 3, description: 'Autonomous chains, environment loops, and self-improving nodes' }
];
...
export const initialSkills: Skill[] = [
  {
    ...
    tags: ['database', 'postgres', 'mcp', 'sql'],
    stars: 842,
    forks: 129,
    updated: '2026-06-20',
    ...
    changelog: [
      { version: 'v1.2.0', date: '2026-05-15', changes: ['Added support for read-only replica connection strings', 'Optimized large schema fetch queries'] },
      { version: 'v1.1.0', date: '2026-04-01', changes: ['Added autocomplete schema suggestions', 'Fixed local host credential parsing issues'] }
    ],
    featured: true,
    trendingToday: true,
    trendingWeek: true,
  ...
  },
  {
    ...
    category: 'automation',
    tags: ['scraping', 'browser', 'automation', 'puppeteer'],
    stars: 1205,
    forks: 245,
    updated: '2026-06-22',
    author: 'anthropic',
    ...
    changelog: [
      { version: 'v2.1.0', date: '2026-06-01', changes: ['Integrated screenshot rendering inline as message blocks', 'Added proxy routing support for scraping blocks'] }
    ],
    featured: true,
    trendingToday: true,
    trendingWeek: false,
  ...
  },
  {
    ...
    category: 'agents',
    tags: ['planning', 'logic', 'reasoning', 'agentic'],
    stars: 2314,
    forks: 387,
    updated: '2026-06-21',
    author: 'claudelabs',
    ...
    changelog: [
      { version: 'v1.0.1', date: '2026-05-10', changes: ['Improved fallback for shorter context models', 'Reduced system prompt token overhead'] }
    ],
    featured: true,
    trendingToday: false,
    trendingWeek: true,
  ...
  },
  {
    ...
    changelog: [
      { version: 'v3.0.0', date: '2026-05-01', changes: ['Added support for multi-file commit groupings', 'Integrated fine-grainted repository white-lists'] }
    ],
    featured: false,
    trendingToday: true,
    trendingWeek: true,
  ...
  },
  {
    ...
    category: 'research',
    tags: ['search', 'web', 'brave', 'realtime'],
    stars: 924,
    forks: 110,
    updated: '2026-06-19',
    author: 'brave-agency',
    ...
    changelog: [
      { version: 'v1.0.4', date: '2026-05-20', changes: ['Improved regional geographic query parameters', 'Reduced response parse latency by 12%'] }
    ],
    featured: false,
    trendingToday: false,
    trendingWeek: true,
  ...
  },
  {
    ...
    category: 'automation',
    tags: ['sandbox', 'docker', 'terminal', 'coding'],
    stars: 1845,
    forks: 310,
    updated: '2026-06-10',
    ...
    changelog: [
      { version: 'v0.8.0', date: '2026-04-18', changes: ['Added isolated python virtualenv cache supports', 'Limit filesystem size limits to 128MB per agent'] }
    ],
    featured: false,
    trendingToday: true,
    trendingWeek: false,
  ...
  },
  {
    ...
    tags: ['google', 'gmail', 'calendar', 'mcp'],
    stars: 720,
    forks: 98,
    updated: '2026-06-12',
    author: 'modelcontextprotocol',
    ...
    changelog: [
      { version: 'v1.1.2', date: '2026-06-02', changes: ['Optimized OAuth token refreshes handles', 'Support recurring events calculations'] }
    ],
    featured: false,
    trendingToday: false,
    trendingWeek: true,
...
export const initialCollections: Collection[] = [
  {
    ...
    colorTheme: 'blue',
    skillsCount: 3,
    skillIds: ['postgres-mcp', 'github-api-mcp', 'docker-sandbox']
  },
  {
    ...
    colorTheme: 'purple',
    skillsCount: 2,
    skillIds: ['sequential-thinking', 'puppeteer-browser']
  },
  {
    ...
    colorTheme: 'zinc',
    skillsCount: 2,
    skillIds: ['brave-search-mcp', 'puppeteer-browser']
  }
];
...
export const initialPrompts: Prompt[] = [
  ...
  },
  {
    ...
    category: 'Marketing',
    tags: ['releases', 'dev-relations', 'copywriting']
  }
];
